...
public class CompileUsingUserInput {
	 ...
	 * static method on the loaded class.
	 */
	private static void simpleExample(String userInput) {
		String classNameA = "ExampleClass";
		// String userInput = JOptionPane.showInputDialog("Enter your code here");
		...
		MethodInvocationUtils.invokeStaticMethod(r.getCompiledClass(classNameA), "exampleMethod", "exampleParameter");
	}
	...
	/**
	 * An example showing how to add two classes (where one refers to the other),
	 * compile them, and invoke a static method on one of them
	 */
	...
	/**
	 * An example that compiles and loads a class, and then uses an instance of this
	 * class
	 */
